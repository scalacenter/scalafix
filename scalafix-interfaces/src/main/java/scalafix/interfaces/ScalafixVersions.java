 ...
 * sources.
 * <p>
 * To obtain an instance of ScalafixVersions, use one of the static methods.
 *
...
public interface ScalafixVersions {
    ...
    /**
     * Obtains an implementation of ScalafixVersions using the current classpath.
     * 
     * @return the first available implementation advertised as a service provider.
     */
    static ScalafixVersions get() {
        ServiceLoader<ScalafixVersions> loader = ServiceLoader.load(ScalafixVersions.class);
