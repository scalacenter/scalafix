...
....
sbt> scalafix dependency:OrganizeImports@com.github.liancheng:organize-imports:0.2.0-RC1
....
...
[source,scala]
----
ThisBuild / scalafixDependencies += "com.github.liancheng" %% "organize-imports" % "0.2.0-RC1"
----
