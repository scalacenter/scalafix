...
class SyntheticSuite extends BaseSemanticSuite("SyntheticTest") {
  ...
  test("text") {
    ...
    val expected =
      """|[200..205): *[List](canBuildFrom[Int])
         |  [0..1): * => _star_.
         |  [2..6): List => scala/package.List#
         |  [8..20): canBuildFrom => scala/collection/immutable/List.canBuildFrom().
         |  [21..24): Int => scala/Int#
         |[209..215): *[Int, Set[Int]]
         |  [0..1): * => _star_.
         |  [2..5): Int => scala/Int#
         ...
         |  [11..14): Int => scala/Int#
         |[224..232): *[List[Int], Int, Set[Int]](canBuildFrom[Int])
         |  [0..1): * => _star_.
         ...
         |  [22..25): Int => scala/Int#
         |  [28..40): canBuildFrom => scala/collection/immutable/Set.canBuildFrom().
         |  [41..44): Int => scala/Int#
         |[247..262): *[Int, List]
         |  [0..1): * => _star_.
         |  [2..5): Int => scala/Int#
         ...
         |[280..288): *[List[Future[Int]], Int, List[Int]](canBuildFrom[Int])
         |  [0..1): * => _star_.
         |  [2..6): List => scala/collection/immutable/List#
         ...
         |  [31..34): Int => scala/Int#
         |  [37..49): canBuildFrom => scala/collection/immutable/List.canBuildFrom().
         |  [50..53): Int => scala/Int#""".stripMargin
