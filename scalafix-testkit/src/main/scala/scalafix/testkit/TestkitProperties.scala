 ...
 *
 * By convention, it's possible to load a `TestkitProperties` instance from the resource
 ...
 * @param sourceroot
 *        The SemanticDB sourceroot used to compile the input sources. Defaults to current
 *        working directory. Must match the value of `-P:semanticdb:sourceroot:&gt;value&lt;`,
 *        if any.
 * @param scalaVersion
 *        The Scala compiler version used to compile the input sources. This information
 *        is passed to rules through the `withConfiguration` method.
 * @param scalacOptions
 *        The Scala compiler options used to compile the input sources. This information
 *        is passed to rules through the `withConfiguration` method.
 */
